...
const ChatHeader = ({ name, online, avatar, isTyping }: ChatHeaderProps) => {
        ...
        <header className="flex items-center justify-between px-4 py-3 border-b bg-card/50 backdrop-blur-sm sticky top-0 z-10 mt-3">
            ...
            <div className="flex items-center gap-1">
                <Button
                    ...
                    className="group bg-gray-200 hover:bg-gray-300 text-gray-800 px-3 py-1.5 rounded-full text-sm font-medium flex items-center gap-2 overflow-hidden transition-all duration-300 hover:scale-105 active:scale-95"
                >
