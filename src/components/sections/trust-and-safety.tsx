...
export const TrustAndSafetySection = () => {
    ...
    return (
        <AnimatedSection>
            <div className="max-w-4xl mx-auto py-16 sm:py-20 lg:py-24 px-4 sm:px-6">
                <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 tracking-tight text-foreground text-center">
                    Why Students ❤️ Our Marketplace
                </h3>
                ...
                <div className="mt-8 sm:mt-12 grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
                    <div className="p-4 rounded-xl shadow bg-card border">
